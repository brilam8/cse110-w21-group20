...
Iain:
    Yesterday - Beginning to work on the Landing page, and the general structure of the page
    Today's Plan - Finishing off the basic functions for the landing page, thinking about the structure and style
    Questions - none
</pre>
...
Iain:
    Yesterday - Finishing off the basic functionalities of the landing page
    Today's Plan - Work on the Lab, study for midterm for another class
    Questions - none
</pre>
...
Iain:
    Yesterday - Studying for classes, and focusing on other work.
    Today's Plan - Taking a midterm, and working on homework for other classes.
    Questions - none.
</pre>
...
Iain:
    Yesterday - Working on other homeworks
    Today's Plan - Thinking about the style of the page and the basic format of the page, working on other class homework
    Questions - none
</pre>
