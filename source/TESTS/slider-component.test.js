customElements.define('slider-component', class extends HTMLElement {
    constructor(){
        ...
        // }
        this.append(style, container); //this.shadowRoot.append(style, container);
    }
...
test('setting to Dark Mode', () => {
    document.body.innerHTML = `<slider-component button-id="dark-mode-button" name="Dark Mode"></slider-component>`
    expect(document.body.innerHTML).toContain('Dark Mode')
})

test('no setting name', () => {
